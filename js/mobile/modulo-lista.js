    ...
    return `
      <div class="space-y-1.5 bg-transparent select-none" id="item-row-${item.id}"
        ...
        <div class="flex items-center">
          <!-- Inputs del Producto (Grid exacto a la cabecera para alineación 100% milimétrica) -->
          ...
          <div id="delete-slot-${item.id}"
            ...
            <button type="button"
              ...
              class="w-10 h-10 ml-2 bg-rose-500 hover:bg-rose-600 active:scale-90 text-white rounded-lg flex items-center justify-center text-xs shadow-2xs shrink-0">
