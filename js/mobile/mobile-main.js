...
import { initReceiptScannerPWA, triggerReceiptScanner } from "./lector-boletas.js?v=9.1";
import { initPullToRefresh, triggerPullRefresh } from "./pull-refresh.js?v=9.1";
import { initVoiceChat, openVoiceChat, closeVoiceChat, handleReceiptInVoiceChat } from "./voice-chat.js?v=9.1";
