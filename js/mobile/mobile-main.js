...
import { initReceiptScannerPWA, triggerReceiptScanner } from "./lector-boletas.js?v=8.8";
import { initPullToRefresh, triggerPullRefresh } from "./pull-refresh.js?v=8.8";
import { initVoiceChat, openVoiceChat, closeVoiceChat, handleReceiptInVoiceChat } from "./voice-chat.js?v=8.8";
