...
import { initReceiptScannerPWA, triggerReceiptScanner } from "./lector-boletas.js?v=7.5";
import { initPullToRefresh, triggerPullRefresh } from "./pull-refresh.js?v=7.5";
import { initVoiceChat, openVoiceChat, closeVoiceChat, handleReceiptInVoiceChat } from "./voice-chat.js?v=7.5";
