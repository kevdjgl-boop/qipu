...
import { initReceiptScannerPWA, triggerReceiptScanner } from "./lector-boletas.js?v=9.3";
import { initPullToRefresh, triggerPullRefresh } from "./pull-refresh.js?v=9.3";
import { initVoiceChat, openVoiceChat, closeVoiceChat, handleReceiptInVoiceChat } from "./voice-chat.js?v=9.3";
