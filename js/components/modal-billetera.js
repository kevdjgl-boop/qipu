/**
 * @class ModalBilletera
 * @extends HTMLElement
 * @description Componente nativo para el modal de Billetera/Métodos de Pago o Creación de Grupo.
 * Mueve la vista lateral de "Conexión/Nuevo Grupo" o "Método de pago" a un componente encapsulado.
 */
export class ModalBilletera extends HTMLElement {
    constructor() {
        super();
    }
    ...
    render() {
        this.innerHTML = `
        <div id="payment-methods-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-gray-600 bg-opacity-70 backdrop-blur-sm p-4 transition-opacity">
                ...
                <div class="flex flex-1 flex-col bg-white p-0 overflow-hidden">
                    ...
                    <form id="payment-method-form" class="flex flex-grow flex-col space-y-8 p-8 overflow-y-auto">
                        ...
                        <div class="space-y-3">
                            ...
                            <input type="text" id="method-name" placeholder="Ej: Visa BCP, Efectivo..." required class="w-full rounded-2xl border-none bg-gray-50 px-5 py-4 text-gray-900 font-semibold placeholder-gray-400 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-indigo-600 transition-shadow" />
                        </div>
                        ...
                        <div id="cc-config-fields" class="hidden space-y-4 rounded-2xl bg-indigo-50 p-5 ring-1 ring-inset ring-indigo-100">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="space-y-1">
                                    ...
                                    <input type="number" id="cc-config-closing-day" min="1" max="31" placeholder="Ej: 8" class="w-full rounded-xl border-none bg-white px-3 py-2.5 text-gray-900 font-bold ring-1 ring-inset ring-indigo-200 focus:ring-2 focus:ring-indigo-600 sm:text-sm" />
                                ...
                                <div class="space-y-1">
                                    ...
                                    <input type="number" id="cc-config-payment-day" min="1" max="31" placeholder="Ej: 5" class="w-full rounded-xl border-none bg-white px-3 py-2.5 text-gray-900 font-bold ring-1 ring-inset ring-indigo-200 focus:ring-2 focus:ring-indigo-600 sm:text-sm" />
...
customElements.define('modal-billetera', ModalBilletera);
