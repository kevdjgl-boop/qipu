...
window.setupCustomSelect = function(selectId, defaultIcon = "fa-circle") {
    ...
    if (!wrapper) {
        ...
        trigger.addEventListener("click", (e) => {
            ...
            if (isOpen) {
                ...
                window.refreshCustomSelect(selectId);
...
window.populateModalTags = function () {
    ...
    if (payerSelect && appState.participants) {
        ...
        window.setupCustomSelect("expense-payer", "fa-user");
    }
    ...
    if (methodSelect && appState.paymentMethods) {
        ...
        window.setupCustomSelect("expense-payment-method", "fa-wallet");
    }
    ...
    if (catSelect) {
        ...
        window.setupCustomSelect("expense-category", "fa-tag");
    }
};
